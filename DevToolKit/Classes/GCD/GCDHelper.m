...
void Execute_Main(dispatch_block_t main) {
...
void Execute_Async(dispatch_block_t async) {
...
void Execute_Delay(CGFloat seconds ,dispatch_block_t delay) {
...
void Execute_Lock_GCD(void (^lock)(dispatch_semaphore_t sema)) {
...
void Execute_Lock_OSSpin(dispatch_block_t lock) {
...
void Execute_TakeTime (dispatch_block_t block, NSString *message) {
